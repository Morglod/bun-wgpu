...
export const glfwRawMouseMotionSupported =
    lib.symbols.glfwRawMouseMotionSupported;
export const glfwGetTime = lib.symbols.glfwGetTime;
export const glfwGetTimerValue = () =>
    lib.symbols.glfwGetTimerValue().toString();
export const glfwGetTimerFrequency = () =>
    lib.symbols.glfwGetTimerFrequency().toString();
...
export const glfwMakeContextCurrent = (window: glfwWindow): void =>
    lib.symbols.glfwMakeContextCurrent(window);
export const glfwSwapInterval = (interval: number): void =>
    lib.symbols.glfwSwapInterval(interval);
export const glfwShowWindow = (window: glfwWindow): void =>
    lib.symbols.glfwShowWindow(window);
export const glfwWindowShouldClose = (window: glfwWindow): boolean =>
    lib.symbols.glfwWindowShouldClose(window);
export const glfwSwapBuffers = (window: glfwWindow): void =>
    lib.symbols.glfwSwapBuffers(window);
export const glfwGetWindowAttrib = (
    window: glfwWindow,
    attribute: number
): boolean => lib.symbols.glfwGetWindowAttrib(window, attribute);
export const glfwDestroyWindow = (window: glfwWindow): void =>
    lib.symbols.glfwDestroyWindow(window);
export const glfwWindowHint = (hint: number, state: number): void =>
    lib.symbols.glfwWindowHint(hint, state);
export const glfwInitHint = (hint: number, state: number): void =>
    lib.symbols.glfwInitHint(hint, state);
export const glfwGetError = (description: string): number =>
    lib.symbols.glfwGetError(Buffer.from(description));
export const glfwWindowHintString = (hint: number, value: string): void =>
    lib.symbols.glfwWindowHintString(hint, Buffer.from(value));
export const glfwSetWindowShouldClose = (
    window: glfwWindow,
    value: number
): void => lib.symbols.glfwSetWindowShouldClose(window, value);
export const glfwSetWindowTitle = (window: glfwWindow, title: string): void =>
    lib.symbols.glfwSetWindowTitle(window, Buffer.from(title));
export const glfwSetWindowPos = (
    window: glfwWindow,
    x: number,
    y: number
): void => lib.symbols.glfwSetWindowPos(window, x, y);
export const glfwSetWindowSize = (
    window: glfwWindow,
    width: number,
    height: number
): void => lib.symbols.glfwSetWindowSize(window, width, height);
export const glfwSetWindowSizeLimits = (
    ...
    lib.symbols.glfwSetWindowSizeLimits(
        window,
        minWidth,
        minHeight,
        maxWidth,
...
export const glfwSetWindowAspectRatio = (
    ...
    numer: number,
    denom: number
): void => lib.symbols.glfwSetWindowAspectRatio(window, numer, denom);
export const glfwGetWindowOpacity = (window: glfwWindow): number =>
    lib.symbols.glfwGetWindowOpacity(window);
export const glfwSetWindowMonitor = (
    ...
    lib.symbols.glfwSetWindowMonitor(
        window,
        monitor,
        x,
        y,
...
export const glfwIconifyWindow = (window: glfwWindow): void =>
    lib.symbols.glfwIconifyWindow(window);
export const glfwRestoreWindow = (window: glfwWindow): void =>
    lib.symbols.glfwRestoreWindow(window);
export const glfwMaximizeWindow = (window: glfwWindow): void =>
    lib.symbols.glfwMaximizeWindow(window);
export const glfwHideWindow = (window: glfwWindow): void =>
    lib.symbols.glfwHideWindow(window);
export const glfwFocusWindow = (window: glfwWindow): void =>
    lib.symbols.glfwFocusWindow(window);
export const glfwRequestWindowAttention = (window: glfwWindow): void =>
    lib.symbols.glfwRequestWindowAttention(window);
export const glfwGetWindowMonitor = (window: glfwWindow): glfwMonitor =>
    lib.symbols.glfwGetWindowMonitor(window);
export const glfwSetWindowAttrib = (
    window: glfwWindow,
    attribute: number,
    value: number
): void => lib.symbols.glfwSetWindowAttrib(window, attribute, value);
export const glfwWaitEventsTimeout = (timeout: number): void =>
    lib.symbols.glfwWaitEventsTimeout(timeout);
export const glfwGetInputMode = (window: glfwWindow, mode: number): number =>
    lib.symbols.glfwGetInputMode(window, mode);
export const glfwSetInputMode = (
    window: glfwWindow,
    mode: number,
    value: number
): void => lib.symbols.glfwSetInputMode(window, mode, value);
export const glfwGetKeyName = (key: number, scancode: number): string =>
    lib.symbols.glfwGetKeyName(key, scancode).toString();
export const glfwGetKeyScancode = (key: number): number =>
    lib.symbols.glfwGetKeyScancode(key);
export const glfwGetKey = (window: glfwWindow, key: number): number =>
    lib.symbols.glfwGetKey(window, key);
export const glfwGetMouseButton = (
    window: glfwWindow,
    button: number
): number => lib.symbols.glfwGetMouseButton(window, button);
export const glfwSetCursorPos = (
    window: glfwWindow,
    x_pos: number,
    y_pos: number
): void => lib.symbols.glfwSetCursorPos(window, x_pos, y_pos);
export const glfwJoystickPresent = (joystick_id: number): number =>
    lib.symbols.glfwJoystickPresent(joystick_id);
export const glfwGetJoystickName = (joystick_id: number): string =>
    lib.symbols.glfwGetJoystickName(joystick_id).toString();
export const glfwJoystickIsGamepad = (joystick_id: number): boolean =>
    lib.symbols.glfwJoystickIsGamepad(joystick_id);
export const glfwSetTime = (time: number): void =>
    lib.symbols.glfwSetTime(time);
export const glfwGetCursorPos = (
    window: glfwWindow,
    xpos: number,
    ypos: number
): number => lib.symbols.glfwGetCursorPos(window, xpos, ypos);
